...
const AdService = () => {
  const seoServiceCard2 = [
    ...
    {
      icons: <Instagram className={`bg-violet-500 h-14 w-14 p-3 rounded-full`} />,
    ...
    {
      icons: (
        <Youtube className={`bg-red-500 h-14 w-14 p-3 rounded-full`} />
      ),
    ...
    {
      icons: <ShoppingBasket className={`bg-lime-300 h-14 w-14 p-3 rounded-full`} />,
  ...
  return (
    <>
      ...
      <div className="mt-10">
       ...
       <div className="flex flex-col md:flex-row-reverse md:px-8 md:py-10 lg:px-16">
        <div className="px-5 md:w-1/2 flex gap-2">
          <video src="../Video/dancingGirls.mp4" autoPlay="true" muted loop="true" className="rounded-xl h-[40vh] md:h-[50vh]  lg:h-[80vh]"/>
          <video src="../Video/girlmorningtrimer.mp4" autoPlay="true" muted loop="true" className="rounded-xl h-[40vh] mt-20 md:h-[50vh] lg:h-[80vh]"/>
        </div>
        ...
        <div className="text-center md:w-1/2 lg:text-left">
          ...
          <p className="px-2.5 text-[15px] text-gray-800 lg:px-7 lg:py-6 lg:text-xl">
           Drive brand awareness and connect with your audience through captivating reels and targeted social media ads. Elevate your marketing strategy with impactful campaigns designed to deliver measurable results.
          </p>
